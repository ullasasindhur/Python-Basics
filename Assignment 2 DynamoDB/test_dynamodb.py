...
@pytest.mark.parametrize("input,output", [
    ...
    ({'Items': [{'Artist': 'Sindhur', 'SongTitle': 'Ullasa'}, {'Artist': 'Sindhur', 'SongTitle': 'a'}, {'Artist': 'Sindhur', 'SongTitle': 'z'}]},
     [{'Artist': 'Sindhur', 'SongTitle': 'z'},  {'Artist': 'Sindhur', 'SongTitle': 'a'}, {'Artist': 'Sindhur', 'SongTitle': 'Ullasa'}]),
